...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful compound interest tool, check it out: https://seosaurus.in/tools/compound-interest-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/compound-interest-calculator/";
